...
# 绘制真实标签
plt.scatter(X_val_pca[:, 0], X_val_pca[:, 1], c=y_val, cmap=plt.cm.Paired, marker='o', label='True Labels')
plt.title('True Labels on Validation Set')
...
# 绘制模型预测标签
plt.scatter(X_val_pca[:, 0], X_val_pca[:, 1], c=y_val_pred, cmap=plt.cm.Paired, marker='x', label='Predicted Labels')
